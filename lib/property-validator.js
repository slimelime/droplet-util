...
function ensureObjectProperties(objectToValidate, requiredProperties) {
    if (!hasRequiredProperties(objectToValidate, requiredProperties)) {
        const error = new UnretryableError(`Missing Object Properties: [${getMissingProperties(objectToValidate, requiredProperties)}]`, errors.codes.Groups.Config, errors.codes.Config.$Object, errors.codes.Config.Properties);
        throw error;
    }
