...
RateLimiter.prototype = {
     ...
     */
    removeTokensSmoothly: (() => {
        var _ref = (0, _asyncToGenerator3.default)(function* (count, chunkPercent = 0.9) {
            ...
            if (count <= this.tokenBucket.bucketSize) {
                ...
                while (consumed < count) {
                    ...
                    remaining = yield removeTokens(chunk);
                    //     new Promise((resolve, reject) => {
                ...
                return [_promise2.default.resolve(remaining)];
            }
        });

        return function removeTokensSmoothly(_x) {
