...
let putRecordWithBackupQueue = (() => {
    var _ref2 = (0, _asyncToGenerator3.default)(function* (streamName, partitionKey, record, queueUrl, options = {}, params = {}) {
        const kinesis = new AWS.Kinesis((0, _extends3.default)({}, commonDefaultOptions, regionDefaultOptions(), options));
        const requiredParams = {
            Data: (0, _stringify2.default)(record),
            PartitionKey: partitionKey,
        ...
        try {
            return yield kinesis.putRecord((0, _extends3.default)({}, requiredParams, params)).promise();
        } catch (err) {
            logger.error(err);
            return yield sqs.sendMessage(queueUrl, record);
        }
    });

    return function putRecordWithBackupQueue(_x4, _x5, _x6, _x7) {
...
let putRecords = (() => {
    var _ref3 = (0, _asyncToGenerator3.default)(function* (streamName, partitionKey, records, options = {}, params = {}) {
        const kinesis = new AWS.Kinesis((0, _extends3.default)({}, commonDefaultOptions, regionDefaultOptions(), options));
        const requiredParams = {
    ...
    return function putRecords(_x8, _x9, _x10) {
