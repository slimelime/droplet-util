...
class UnretryableError extends _extendableBuiltin(Error) {
...
class DuplicateEventError extends _extendableBuiltin2(Error) {
    static get [_species2.default]() {
        return Error;
    }
...
class TimeoutError extends _extendableBuiltin3(Error) {
    static get [_species2.default]() {
        return Error;
    }
...
class AuthenticationError extends _extendableBuiltin4(Error) {
    static get [_species2.default]() {
        return Error;
    }
